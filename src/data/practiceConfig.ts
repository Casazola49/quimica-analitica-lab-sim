// Configuración canónica de la práctica de referencia (P4: Estandarización de Soluciones de NaOH)
// Derivada directamente de data/curriculum_spec.json (UMSS)
...
export interface PracticeDefinition {
  ...
  primaryStandard: {
    ...
    equivalentWeight: number; // KHP: C8H5KO4 = 204.22 g/eq
    nominalMassMin: number; // 0.2000 g
  ...
  indicator: {
    ...
    pKin: number; // 9.3
    transitionRange: [number, number]; // [8.2, 10.0]
    optimalDrops: number; // 2 - 3 gotas
  };
}
